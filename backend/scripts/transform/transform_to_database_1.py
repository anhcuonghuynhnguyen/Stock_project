...
if __name__ == "__main__":
    ...
    path = r"/home/anhcu/Project/Stock_project/backend/data/processed/transformed_to_database_regions/process_regions_" + f"{date}.json"
    ...
    path = r"/home/anhcu/Project/Stock_project/backend/data/processed/transformed_to_database_industries/process_industries_" + f"{date}.json"
    ...
    path = r"/home/anhcu/Project/Stock_project/backend/data/processed/transformed_to_database_sicindustries/process_sicindustries_" + f"{date}.json"
