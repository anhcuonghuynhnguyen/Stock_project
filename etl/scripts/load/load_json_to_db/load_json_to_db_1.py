...
if __name__ == "__main__":
    insert_data_from_json(
        get_latest_file_in_directory('etl/data/processed/transformed_to_database_regions','.json'),
        'regions',
    ...
    insert_data_from_json(
        get_latest_file_in_directory('etl/data/processed/transformed_to_database_industries','.json'),
        'industries',
    ...
    insert_data_from_json(
        get_latest_file_in_directory('etl/data/processed/transformed_to_database_sicindustries','.json'),
        'sicindustries',
