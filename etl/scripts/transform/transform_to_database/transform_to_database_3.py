...
if __name__ == "__main__":
    ...
    # Đọc file JSON
    companies_json = read_latest_file_in_directory('etl/data/raw/crawl_apis/companies')
    ...
    path = r"etl/data/processed/transformed_to_database_companies/process_companies_" + f"{date}.json"
